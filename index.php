...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-4 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item ">
        <a href="./php/modificar_automovil.php" class="nav-link">
          <span class="sidebar-icon">
            ...
            <div class="py-4">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                        <a class="dropdown-item d-flex align-items-center" href="./php/modificar_automovil.php">
...
<div class="row">
    <div class="col-12 text-center">
        <div class="card border-0 shadow">
            <div class="card-body">
                <h2 class="fw-extrabold">Bienvenido Administrador</h2>
            </div>
        </div>
    </div>
</div>
...
<!-- FOOTER -->
<footer class="bg-white rounded shadow p-4 mb-4 mt-12">
    <div class="row">
